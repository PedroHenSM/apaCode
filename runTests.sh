...
totalDimensions=6 # 8/7 Maybe 7 is enough | for 100000000 took 35674691 microseconds approx
...
do
	...
	do
		...
		do
			...
			do
				echo "Executing method ${methods[m]} with seed ${seeds[s]} with shufflePercentage ${shuffles[sh]} and dimension ${dimensions[n]}"
